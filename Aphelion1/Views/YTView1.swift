...
struct YTView1: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            .position(x: 0, y: Constants.screenHeight * 0.4)
            ...
            //settings
            YTSettingsElement(fontSize: 14, stepperWidth: 100, stepperHeight: 22, spacing: 12, width: Constants.screenWidth * 0.33, height: Constants.screenHeight * 0.2)
                .position(x: Constants.screenWidth * 0.26 - 2, y: Constants.screenHeight * 0.71)
            
            //confirm button
            ConfirmButton(fontSize: 18, width: Constants.screenWidth * 0.24)
                .position(x: Constants.screenWidth * 0.26 - 2, y: Constants.screenHeight * 0.91)
